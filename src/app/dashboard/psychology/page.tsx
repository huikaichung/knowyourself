  ...
  const tests = [
    {
      id: 'bigfive',
      name: 'Big Five 人格測驗',
      desc: '心理學界最廣泛使用的人格模型，測量五大面向及30個子面向。基於 IPIP-NEO 公開題庫。',
      questions: 60,
      time: '10-15 分鐘',
      color: '#3b82f6',
      status: 'available',
    },
    {
      id: 'mbti',
      name: 'MBTI 16型人格',
      desc: '榮格理論基礎的性格類型指標，分析你的認知功能偏好：外向/內向、實感/直覺、思考/情感、判斷/知覺。',
      questions: 70,
      time: '15-20 分鐘',
      color: '#10b981',
      status: 'available',
    },
    {
      id: 'enneagram',
      name: '九型人格',
      desc: '深入探索你的核心動機、恐懼與渴望。發現你的主要類型和翼型。',
      questions: 36,
      time: '8-12 分鐘',
      color: '#f59e0b',
      status: 'available',
    },
    {
      id: 'attachment',
      name: '依附風格',
      desc: '基於 ECR-R 量表，了解你在親密關係中的模式：安全型、焦慮型、迴避型或恐懼型。',
      questions: 20,
      time: '5 分鐘',
      color: '#ec4899',
      status: 'available',
